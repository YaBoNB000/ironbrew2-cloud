...
GuardProbe = function(Force)
    ...
    if not GuardAttested then
        ...
        GuardEvidenceC = (GuardBXor(GuardCompatibility, 2781082087) * 131071 + 2135587861) % 4294967296;
        GuardEvidenceD = (GuardBXor(GuardCompatibility, 3302136427) * 524287 + 3266489909) % 4294967296;
